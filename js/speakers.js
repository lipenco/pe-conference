...
function calculatePositions($currentrow) {
  ...
  $('.speaker-description-container').css('top', $oh.top + $tallest_item_height + 100);
  
  $start_next = 0 + (($currentrow+1) * 5);
  
  $end_next = 4 + (($currentrow+1) * 5);
  ...
  totalHeight += parseInt(theDiv.css("padding-top"), 30) + parseInt(theDiv.css("padding-bottom"), 10); //Total Padding Width
  totalHeight += parseInt(theDiv.css("margin-top"), 30) + parseInt(theDiv.css("margin-bottom"), 10); //Total Margin Width
